								...
								<div class="col-xs-12 col-sm-6 wow fadeInRight review-right">
									<div class="review-info">
										...
										<div class="title plan">
											<span>Your Plan</span> <span><label id="Plan"></label></span>
											<h5>Meals for Breakfast, Lunch and Dinner </h5>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="container">
							...
							<div class="payment-method-block">
								...
								<div class="row text-center select-payment-btns">
										...
										</svg> <span style="font-weight:bold;">Bank Transfer</span>
											</div>
										
												 
										
										</div>
									<span class="errorspan" id="Paymenterror"></span>
