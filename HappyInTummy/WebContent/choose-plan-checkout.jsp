...
<script>
/* $.get("choose-plan-review.html", function (data) {
    $("#reviewDetails").replaceWith(data);
}); */
								...
								<div class="col-xs-12 col-sm-6 wow fadeInLeft review-left">
									<div class="review-info">
										<div class="title name">
											<span>Your Name</span> <span><label id="Name"></label></span>
										</div>
										<div class="title gender">
											<span>Gender</span> <span><label id="Gender"></label></span>
										</div>
										<div class="title email">
											<span>Email</span> <span><label id="Email"></label></span>
										</div>
										<div class="title address">
											<span>Address</span> <span><label id="Address"></label><br /><label id="Zip"></label>
											</span>
										</div>
										<div class="title Phone">
											<span>Phone</span> <span><label id="Phone"></label>
											</span>
										</div>
										<div class="title Date of Birth">
											<span>Date of Birth</span> <span><label id="DOB"></label>
											</span>
										</div>
									</div>
								</div>
								<div class="col-xs-12 col-sm-6 wow fadeInRight review-right">
									<div class="review-info">
										<div class="title program">
											<span>Your Program</span> <span> <label id="Program"></label></span>
										</div>
										<div class="title plan">
											<span>Plan</span> <span><label id="Plan"></label></span>
											<p>Meals for Breakfast, Lunch and Dinner </p>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="step3">
						<div class="container">
							...
							<div class="top-description">
								<h5 class="text-uppercase wow fadeInUp text-center">SELECT
									PAYMENT OPTION</h5>
							</div>
							<!-- top text header ends -->
							<!-- payment method block starts -->
							<div class="payment-method-block">
								<!-- Select payment method block starts -->
								<div class="row text-center select-payment-btns">
								
									<div class="col-xs-12 col-sm-6 wow fadeInUp select-payment-btn">
										<a class="hvr-wobble-horizontal" href="#"> 
